...
- Create a file named **`hotel-options-config.ts`** if it doesn’t exist.
...
                <label className="px-1 text-gray-700 font-normal" key={facility}>
                    <input
                      type="checkbox"
                      value={facility}
...
                      }})}
                      ></input>
                    <span className="px-1">{facility}</span>
                </label>
            ))}
        </div>
        { errors.facilities && (
           <span className="text-red-500 text-sm font
           bold">errors.facilities.message</span>
         )
        }
     </div>
   );
